                    ...
                    <div className="flex relative inline-block float-right">
                        ...
                        <div className="relative text-sm">
                            <button id="userButton" className="flex items-center focus:outline-none mr-3">
                                ...
                                <svg className="pl-2 h-2" version="1.1" xmlnsXlink="http://www.w3.org/2000/svg" viewBox="0 0 129 129" xlinkHref="http://www.w3.org/1999/xlink" enableBackground="new 0 0 129 129">
                                    <g>
                        ...
                        <div className="block lg:hidden pr-4">
                            <button id="nav-toggle" className="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-gray-900 hover:border-teal-500 appearance-none focus:outline-none">
                                <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlnsXlink="http://www.w3.org/2000/svg">
                                    <title>Menu</title>
                ...
                <div className="w-full px-2 flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
                    ...
                    <div className="relative pull-right pl-4 pr-4 md:pr-0">
                        ...
                        <div className="absolute search-icon" style={{top: '0.375rem', left: '1.75rem'}}>
                            <svg className="fill-current pointer-events-none text-gray-800 w-4 h-4" xmlnsXlink="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
