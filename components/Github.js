                        ...
                        <div className="bg-white rounded-lg shadow-xl">
                            <div className="p-16">
                                ...
                                <div className="mt-8 text-center">
                                    ...
                                    <div className="pt-10">
                                        <a href="https://github.com/myphpmaster/sufian.cloud" className="mt-6 bg-blue-500 hover:bg-blue-400 text-white rounded-full px-12 py-3 shadow-xl focus:outline-none">
                                            Get source code
                                        </a>
                                    </div>
                                </div>
