                ...
                <main className="min-h-screen items-center flex mx-auto max-w-7xl px-4 mt-0 sm:px-6 lg:px-8 justify-center" style={{ 'minHeight':'calc(100vh - 64px)'}}>
                    <div className="sm:text-center lg:text-left px-4">
                        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span className="block xl:inline">Questionnaire </span> <br />
                            <span className="block text-indigo-600 xl:inline">Survey Form</span>
                        </h1>
                        
                        <div className="flex my-10">
 
                            <blockquote className="text-2xl flex flex-wrap flex-col bg-white text-indigo-700 border-l-8 italic border-gray-400 px-4 py-3">
