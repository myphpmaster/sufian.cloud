  ...
  return (
        ...
        <nav id="header" className="bg-white fixed w-full z-10 top-0 shadow">
            <div className="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
                ...
                <div className="w-1/2 pr-0">
                    <div className="flex relative inline-block float-right">
                        ...
                        <div className="block lg:hidden pr-4">
                            <button onClick={handleClick} name="mobile" id="nav-toggle" className="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-gray-900 hover:border-teal-500 appearance-none focus:outline-none">
                ...
                <div className={`${ (isOpen.mobile) ? '' : 'hidden' } w-full px-2 flex-grow lg:flex lg:items-center lg:w-auto lg:block mt-2 lg:mt-0 bg-white z-20`} id="nav-content">
